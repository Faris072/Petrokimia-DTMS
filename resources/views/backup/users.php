                ...
                <table class="table table-bordered" border="0">
                    ...
                    <tr>
                        ...
                        <td width="40%" valign="middle">
                            <b>JAYA ANDITAMA</b>
                            <br>
                            <span class="text-muted">yaja.anditama</span>
                        </td>
                        <td valign="middle">
                            <span style="color: rgb(101, 101, 255);">Administrator</span>
                        </td>
                        <td valign="middle">
                            <div class="switch"></div>
                        </td>
                        <td valign="middle">
                            <a class="edit p-2 py-1" data-toggle="modal" data-target="#ubah" style="background-color:rgba(139, 212, 218, 0.192); border-radius:5px;"><i class="fas fa-sync"></i></a>

                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" id="pimpinan" placeholder="Cth: Lukman Hasyim" class="form-control">
                            </div>
                            <div class="col-md-4">
                                <label for="perusahaan">Nama Perusahaan</label>
                                <input type="text" id="perusahaan" placeholder="Cth: PT Transportasi" class="form-control">
                            </div>
                            <div class="col-md-4">
            ...
            <div class="tabel">
                <table class="table table-bordered" border="0">
                    ...
                    <tr>
                        ...
                        <td valign="middle">Moch. Saiful</td>
                        <td valign="middle">
                            <b>CV PARAMA MANDIRI</b>
                            <br>
                            <span class="text-muted">Jl. Bali Blok H 15, Gresik</span>
                        </td>
                        <td valign="middle">085731585930</td>
                        <td valign="middle">
